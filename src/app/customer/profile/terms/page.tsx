  ...
  return (
    <div className="max-w-md mx-auto bg-white border border-[#f0ebde]/75 rounded-[2.5rem] p-8 shadow-sm text-right space-y-6">
      ...
      <div className="space-y-4 text-xs text-[#666666] leading-relaxed">
        ...
        <p>مرحباً بك في منصة محاصيل، يرجى قراءة الشروط والأحكام بدقة قبل استخدام التطبيق.</p>

        <h4 className="font-bold text-[#333333]">1. الصفقات والبيع الفوري:</h4>
        <p>
          يلتزم المشتري بدفع قيمة المحصول فور تأكيد البائع لقبول الطلب عبر بوابة دفع مويسر
          الإلكترونية المتاحة في التطبيق.
        </p>

        <h4 className="font-bold text-[#333333]">2. المزايدات والمزادات:</h4>
        <p>
          يعد تقديم المزايدة في المزاد العلني التزاماً مالياً وقانونياً بالدفع في حال فوز السوم، ولا
          يجوز سحب السوم بعد اعتماده.
        </p>
