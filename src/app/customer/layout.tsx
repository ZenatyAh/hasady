...
function StarIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499c.173-.434.762-.434.935 0l1.861 4.67 4.908.232c.474.022.663.606.319.923l-3.774 3.486 1.09 4.88c.105.47-.394.832-.801.564L12 15.61l-4.288 2.525c-.407.268-.906-.094-.801-.564l1.09-4.88-3.774-3.486c-.344-.317-.155-.901.319-.923l4.908-.232 1.861-4.67z" />
    </svg>
  );
}
