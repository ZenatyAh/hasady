// src/app/merchant/notifications/page.tsx
...
const DEFAULT_NOTIFICATIONS: NotificationItem[] = [
  {
    ...
    message:
      'تمت عملية البيع بنجاح والآن يمكنك ارسال البضاعة للتاجر الذي قام بشراء البضاعة تواصل مع التاجر لاتمام العملية',
    date: '14-09-2025',
    isRead: false,
  },
  {
...
export default function NotificationsPage() {
  ...
  const [notifications, setNotifications] = useState<NotificationItem[]>(() => {
    if (typeof window !== 'undefined') {
      const stored = sessionStorage.getItem('hasady-notifications');
      if (stored) {
        try {
        ...
        sessionStorage.setItem('hasady-notifications', JSON.stringify(DEFAULT_NOTIFICATIONS));
        return DEFAULT_NOTIFICATIONS;
      }
    }
    return DEFAULT_NOTIFICATIONS;
  ...
  const markAllAsRead = () => {
    ...
    if (typeof window !== 'undefined') {
      sessionStorage.setItem('hasady-notifications', JSON.stringify(updated));
    }
  };
          ...
          <div className="space-y-3.5 max-h-[600px] overflow-y-auto pr-1">
            {notifications.length === 0 ? (
              ...
              notifications.map((notif) => (
                ...
                >
                  {/* Right: Green Bell Icon container */}
